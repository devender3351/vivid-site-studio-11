        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-xs font-medium text-accent"
            >
            ...
            <div className="space-y-5">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-muted-foreground">Dr. Devender Rapolu Presents</p>
              <h1 className="apple-text-hero">
                VR{" "}<span className="text-gradient">Entertainment</span>
              </h1>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <MagneticButton>
                <Button variant="hero" size="lg" className="gap-2 rounded-full px-8 h-14 text-base">
